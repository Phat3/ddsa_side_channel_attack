...
\end{itemize}
\section{Results}
We have tested these attacks on 4 key length:
\begin{itemize}
...
\end{itemize}
The resulting times are obtained using an AMD Quad-Core A8-4500M 2.8/1.9 GHz , 4GB ram.
...
\hline
         & Avg time   \\ \hline
Length 1 & 2.241930 ms \\ \hline
Length 2 & 7.508261 ms \\ \hline
Length 3 & 8.846499 ms \\ \hline
Length 4 & 16.900461 ms \\ \hline
\end{tabular}
\end{table}
